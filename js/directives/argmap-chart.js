    ...
    angular.module('argmap.directives')
        .directive('argmapChart', ['default_messages', 'd3', function(default_messages, d3) {
            return {
                ...
                // directive declaration in the template
                // chartSetCallback is a callback function that allows passing the
                // chart to the controller's scope
                scope: {
                    ideas: '=',
                    edges: '=',
                    chartSetCallback: '&',
                ...
                link: function (scope, iElement, iAttrs) {
                    d3.d3().then((d3) => {
                        ...
                        var svg = d3.select(iElement[0])
                            ...
                            let graph = new GraphCreator(svg, scope.ideas, scope.edges);
                            graph.setIdCt(2);
                            graph.updateGraph();
