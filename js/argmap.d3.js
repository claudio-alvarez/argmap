document.onload = (function(d3, saveAs, Blob, undefined){
    ...
    var docEl = document.documentElement,
        argmapContainerEl = document.getElementById('argmap');
    //bodyEl = document.getElementsByTagName('body')[0];

    var width = window.innerWidth || docEl.clientWidth || argmapContainerEl.clientWidth,
        height =  window.innerHeight|| docEl.clientHeight|| argmapContainerEl.clientHeight;
    ...
    // initial node data
    var nodes = [{title: "Premise", id: 0, x: xLoc, y: yLoc},
        {title: "Conclusion", id: 1, x: xLoc, y: yLoc + 200}];
    var edges = [{source: nodes[0], target: nodes[1]}];

    /** MAIN SVG **/
    var svg = d3.select("#argmap")
        .append("svg:svg")
        .attr("width", '100%')
        .attr("height", '100%')
